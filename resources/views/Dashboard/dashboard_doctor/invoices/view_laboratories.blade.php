...
@section('title')
    {{ trans('dash_doctor_trans.diagnostics') }}
@stop
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('dash_doctor_trans.pictures_tests') }}</h4><span
...
@section('content')
    ...
    <div class="form-group">
        <label for="exampleFormControlTextarea1">{{ trans('dash_doctor_trans.laboratory_doctor_notes') }}</label>

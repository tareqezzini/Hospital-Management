...
@section('title')
    {{ trans('dash_doctor_trans.appointments') }}
@stop
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('dash_doctor_trans.appointments') }}</h4><span
                    ...
                    <table class="table text-md-nowrap" id="example1">
                        <thead>
                            <tr>
                                ...
                                <th>{{ trans('dash_doctor_trans.date_appointment') }}</th>
                        ...
                        <tbody>
                            @foreach ($invoices as $invoice)
                                <tr>
                                    ...
                                    <td>{{ \App\Models\dashboard\Diagnostic::where(['invoice_id' => $invoice->id])->first()->review_date }}
                                    </td>
                                    <td>
                                        <div class="dropdown">

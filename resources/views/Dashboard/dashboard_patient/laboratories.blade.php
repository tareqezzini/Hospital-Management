        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('dash_patient_trans.patient_info') }}</h4><span
                    ...
                    {{ trans('dash_patient_trans.labo') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <div class="table-responsive">
                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>{{ trans('dash_patient_trans.desc') }}</th>
                                    <th>{{ trans('dash_patient_trans.patient_doctor') }}</th>
                                    <th>{{ trans('dash_patient_trans.labo_name') }}</th>
                                    <th>{{ trans('dash_patient_trans.labo_desc') }}</th>
                                    <th>{{ trans('dash_patient_trans.process') }}</th>
                                </tr>
                            </thead>
                            <tbody>
                                        ...
                                        <td>
                                            @if ($laboratorie->employee_id !== null)
                                                <a class="btn btn-primary btn-sm"
                                                    ...
                                                    role="button">{{ trans('dash_patient_trans.process') }}view_analysis</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach

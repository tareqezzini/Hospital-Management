        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('dash_patient_trans.patient_info') }}</h4><span
                    ...
                    {{ trans('dash_patient_trans.x_ray') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ trans('dash_patient_trans.x-ray_name') }}</th>
                                    <th>{{ trans('dash_patient_trans.x-ray_desc') }}</th>
                                        ...
                                        <td>
                                            @if ($ray->employee_id !== null)
                                                <a class="btn btn-primary btn-sm" href="{{ route('rays.view', $ray->id) }}"
                                                    role="button">{{ trans('dash_patient_trans.x-ray_view') }}</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach

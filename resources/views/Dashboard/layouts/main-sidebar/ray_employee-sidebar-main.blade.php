        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">{{ trans('dash_xray_trans.x_ray') }}</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item"
                            href="{{ route('rayInvoices.index') }}">{{ trans('dash_xray_trans.list_diagnoses') }}</a>
                    </li>
                    <li><a class="slide-item"
                            href="{{ route('completed_invoices') }}">{{ trans('dash_xray_trans.x_ray_completed') }}</a>
                    </li>
                </ul>
            </li>
        </ul>

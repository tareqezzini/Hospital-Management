...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <br>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('dashboard.labo_employee') }}"><svg
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">{{ trans('dash_xray_trans.labo_diagnoses') }}</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item"
                            href="{{ route('laboInvoices.index') }}">{{ trans('dash_xray_trans.list_diagnoses') }}</a>
                    </li>
                    <li><a class="slide-item"
                            href="{{ route('completed_invoices_labo') }}">{{ trans('dash_xray_trans.diagnoses_completed') }}</a>
                    </li>
                </ul>
            </li>
        </ul>

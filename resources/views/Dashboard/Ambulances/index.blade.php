...
@endsection
@section('title')
    {{ trans('ambulance_trans.ambulance') }}
@endsection
@section('page-header')
    <!-- breadcrumb -->
        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('ambulance_trans.ambulance') }}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/{{ trans('ambulance_trans.ambulance') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('Ambulance.create') }}"
                            class="btn btn-primary">{{ trans('ambulance_trans.add_new_car') }}</a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ trans('ambulance_trans.manufacturing_year') }}</th>
                                    <th>{{ trans('ambulance_trans.type_car') }}</th>
                                    <th>{{ trans('ambulance_trans.driver_name') }}</th>
                                    <th>{{ trans('ambulance_trans.license_number') }}</th>
                                    <th>{{ trans('ambulance_trans.phone') }}</th>
                                    <th>{{ trans('ambulance_trans.status_car') }}</th>
                                    <th>{{ trans('ambulance_trans.description') }}</th>
                                    <th>{{ trans('ambulance_trans.processes') }}</th>

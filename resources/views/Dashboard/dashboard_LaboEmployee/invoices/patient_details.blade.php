...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('dash_xray_trans.attachments_tests') }}</h4><span
...
@section('content')
    ...
    <div class="form-group">
        <label for="exampleFormControlTextarea1">{{ trans('dash_xray_trans.labo_notes') }}</label>

...
@endsection
@section('title')
    {{ trans('dash_xray_trans.dashboard_labo') }}
@endsection
@section('page-header')
    <!-- breadcrumb -->
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">{{ trans('dash_xray_trans.dashboard_labo') }}</h2><br>
    ...
    <div class="row row-sm">
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-18 text-white">{{ trans('dash_xray_trans.number_diagnoses') }}</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ App\Models\dashboard\Laboratorie::where('doctor_id', auth()->user()->id)->count() }}
                                </h4>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-success-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h3 class="mb-3 tx-18 text-white">{{ trans('dash_xray_trans.number_diagnoses_process') }}</h3>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ App\Models\dashboard\Laboratorie::where('doctor_id', auth()->user()->id)->where('case', 3)->count() }}
                                </h4>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-warning-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-18 text-white">{{ trans('dash_xray_trans.number_diagnoses_completed') }}</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ App\Models\dashboard\Laboratorie::where('doctor_id', auth()->user()->id)->where('case', 2)->count() }}
                                </h4>
                            </div>
            ...
            <div class="card card-table-two">
                ...
                <div class="table-responsive country-table">
                    <table class="table table-striped table-bordered mb-0 text-sm-nowrap text-lg-nowrap text-xl-nowrap">
                        ...
                        <tbody>
                            @forelse(\App\Models\dashboard\Laboratorie::latest()->take(5)->get() as $invoice)
                                <tr>
